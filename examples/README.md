...
`reproduce_cemc_percolation_Li1p2Mn0p4Ti0p4O2.ipynb` generates CEMC structures
at 100 K, 1000 K, 10000 K, and 100000 K for Li1.2Mn0.4Ti0.4O2, then runs Li
percolation analysis to reproduce the Fig. 2b workflow. It defaults to five
structures per temperature and can be changed to 100 for manuscript-scale
statistics.
